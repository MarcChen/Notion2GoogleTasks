...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Save Google API tokens to a specified directory.")
    parser.add_argument("--save_dir", type=str, required=True, help="The directory to save the token.json file.")
